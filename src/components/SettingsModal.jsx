...
export default function SettingsModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-4 bg-slate-900/50 dark:bg-slate-950/80 backdrop-blur-md animate-fade-in">
      <div className="relative w-full max-w-lg liquid-glass-elevated rounded-2xl p-5 sm:p-7 border border-emerald-500/30 shadow-2xl space-y-5">
        ...
        <form onSubmit={handleSubmit} className="space-y-3.5">
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                placeholder="4.9765"
              />
              <span className="absolute right-3.5 top-2 text-xs text-slate-400 font-mono">
          ...
          <div className="pt-3 border-t border-slate-200/80 dark:border-slate-800 flex items-center justify-between">
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-2 text-xs font-semibold text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white bg-slate-100 dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 transition-colors touch-target"
            >
            ...
            <button
              type="submit"
              className="flex items-center gap-1.5 px-4 sm:px-5 py-2 text-xs font-bold text-white bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 rounded-xl shadow-sm transition-all touch-target"
            >
